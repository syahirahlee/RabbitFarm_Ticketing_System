    ...
    <tr>
      <td> <p align="center"><img src="pic/2.png" alt="" width="177" height="134" /><img src="pic/logo2.png" alt="" width="304" height="172" /> <img src="pic/3.png" alt="" width="179" height="138" /></p>
        <ul id="MenuBar1" class="MenuBarHorizontal">
          ...
          <li>
            <div align="center" class="style9"><a href="About.php" class="style57">About</a></div>
          </li>
          <li>
            <div align="center" class="style57"><a href="Contact.php" class="style9">Contact Us</a></div>
          </li>
        </ul>
        <p align="center">&nbsp;</p>      </td>
    </tr>
...
<form id="form2" name="form2" method="POST">
  <table width="44%" border="0" align="center">
    <tr>
      <td height="91" colspan="2"><div align="center"><span class="style28">Ticket Rates</span></div></td>
    </tr>
    <tr>
      <td width="72%" height="91" bgcolor="#66CC99"><p class="style61">Normal Rate (Adult and Children)</p>
      <p><strong>*Kids below 2 years old free of charge</strong></p></td>
      <td width="28%" bgcolor="#CCCCCC"><div align="center"><span class="style61">RM 8</span></div></td>
    </tr>

    <tr>
      <td height="70" bgcolor="#66CC99"><p class="style61">School Package</p>
      <p><strong>*Mininum number of pax is 40</strong></p></td>
      <td bgcolor="#CCCCCC"><div align="center"><span class="style61">RM 40</span></div></td>
    </tr>
    <tr>
      <td height="70" colspan="2" bgcolor="#F0F0F0"><p>School package includes special privilleges to animal petting and feeding as well as fun planned activities and lunch provided.</p>
      </td>
    </tr>
  </table>
  <p>&nbsp;</p>
  <table width="80%" border="0" align="center">
    <tr>
      ...
      <td width="60%"><div align="center">
        <input name="login" type="button" class="button1" id="login" onclick="MM_goToURL('parent','login.php');return document.MM_returnValue" value="LOGIN NOW TO BUY TICKET" />
      </div></td>
    </tr>
  </table>
