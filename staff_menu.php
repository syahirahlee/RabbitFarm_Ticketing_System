...
$MM_restrictGoTo = "customer_menu.php";
...
$colname_Staff_Menu = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_Staff_Menu = $_SESSION['MM_Username'];
}
mysql_select_db($database_rabbitfarm, $rabbitfarm);
$query_Staff_Menu = sprintf("SELECT * FROM tblcustomer WHERE Username = %s", GetSQLValueString($colname_Staff_Menu, "text"));
$Staff_Menu = mysql_query($query_Staff_Menu, $rabbitfarm) or die(mysql_error());
$row_Staff_Menu = mysql_fetch_assoc($Staff_Menu);
$totalRows_Staff_Menu = mysql_num_rows($Staff_Menu);
?>
...
.button1121 {background-color:#6666CC;
    border: none;
    color: white;
    padding: 10px 20px;
    text-align: center;
          ...
          <li>
            <div align="center"><a href="#" class="MenuBarItemSubmenu style7 style8 style18">Attractions</a>
                <ul>
                  ...
                  <li><a href="Facilities.php" class="style25">Facilities</a></li>
                </ul>
            </div>
          </li>
          <li>
    ...
    <blockquote>
      <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <table width="65%" border="1" bordercolor="#66CCCC">
                <tr>
                  <td><div align="center">
                      <div align="center">
                        <p><img src="pic/TEST2.png" width="344" height="207" /></p>
                        <p align="center"><span class="style28"><span class="style28 style31">Welcome <?php echo $row_Staff_Menu['Username']; ?> !
                          <?php $_SESSION["MM_Username"]; ?>
                        </span></span></p>
                      </div>
                    <div align="center">
                        <p>
                          <input name="Add" type="button" class="button112" id="Add" onclick="MM_goToURL('parent','staff_add.php');return document.MM_returnValue" value="Add Customers Ticketing Record" />
                        </p>
                        <p>
                          <input name="SEARCH" type="button" class="button112" id="SEARCH" onclick="MM_goToURL('parent','staff_search.php');return document.MM_returnValue" value="Search Customer Ticketing Record" />
                        </p>
                        <p>
                          <input name="UPDATE" type="button" class="button112" id="UPDATE" onclick="MM_goToURL('parent','staff_update.php');return document.MM_returnValue" value="Update Customer Ticketing Record" />
                        </p>
                      <p>
                          <input name="delete" type="button" class="button112" id="delete" onclick="MM_goToURL('parent','staff_delete.php');return document.MM_returnValue" value="Delete Customers Ticketing Record" />
                        </p>
                      <p>
                          <input name="report" type="button" class="button112" id="report" onclick="MM_goToURL('parent','staff_report.php');return document.MM_returnValue" value="View Report" />
                        </p>
                      <p class="style29"><a href="<?php echo $logoutAction ?>" class="style33">Log Out</a> </p>
                    </div>
                  </div></td>
                </tr>
              </table>
