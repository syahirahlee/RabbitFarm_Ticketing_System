...
<form id="form2" name="form2" method="POST">
  ...
  <table width="76%" border="0" align="center">
    <tr>
      <td width="31%"><p align="right" class="style56"><img src="pic/Mobile-Icon.png" width="132" height="126" /></p>
        <p class="style57">&nbsp;</p>
        <p align="right"><img src="pic/gps.png" width="102" height="103" /></p>      </td>
      <td width="69%"><blockquote>
        <p class="style57">&nbsp;</p>
        <p class="style57"><span class="style56">Contact</span></p>
        <p class="style57">Tel no: 03-9173 3228</p>
        <p class="style57">Email : jwwong@earcsb.com</p>
      </blockquote>
        <p class="style57">&nbsp;</p>
      <p class="style57">&nbsp;</p>
      <blockquote>
        <p><span class="style17 style26"><em><strong>Location </strong></em></span></p>
        <p><span class="style17 style26">N34, Kampung Sungai Gunung Machang Ulu, 71750 Lenggeng, </span></p>
        <p><span class="style17 style26">Negeri Sembilan</span></p>
      </blockquote></td>
    </tr>
  </table>
